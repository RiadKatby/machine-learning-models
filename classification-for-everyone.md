...
تعطينا مصفوفة الأرتباك الكثير من المعلومات، لكن أحياناً نفضل مقياساً موجزاً، والدقة هو أحد مقاييس التنبؤات الإيجابية للمصنف:
المعادلة 3-1. الدقة
$precision=\frac{TP}{TP+FP}$

TP هو عدد الإيجابيات الحقيقية true positive، وFP هو عدد الإيجابيات الخاطئة.
# فهرس الترجمة
| المصطلح | الترجمة |
| ---------- |  ---------- |
| class    | فئة      |
