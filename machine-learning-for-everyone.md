...
<img src="/assets/Paper.ML_Models.1.1.png" alt="شكل المعلومات قبل تعلم الآلة" style="zoom:50%;" />
...
<img src="/assets/Paper.ML_Models.1.2.png" alt="شكل نموذج الإنحدار الخطي بعد تعلم الآلة" style="zoom:50%;" />
...
<img src="/assets/Paper.ML_Models.2.png" alt="شكل نموذج الإنحدار الخطي بعد تعلم الآلة" style="zoom:50%;" />
...
تعتبر ثاني اكثر بنى الشبكات العصبية شهرة هذه الأيام، لعبت الشبكة التكرارية دوراً كبير في مجالات مثل الترجمة الآلية، والتعرف على الكلام، والفهم الصوتي في المساعدين الشخصيين مثل أليكسا وسيري، وتعد الأفضل للبيانات المتسلسلة مع الوقت مثل الصوت، أو النصوص أو الموسيقى.

من يذكر Microsoft Sam مركب الكلام القديم الذي كان موجوداً في نظام تشغيل Windows XP؟ ذلك الصوت المضحك الذي يحاول بناء الكلامات حرفاً بحرف في محاولة لنطقها معاً. قارنه فقط بإمكانيات أليكسا من أمازون أو مساعد قوقل، إنهم ينطقون الكلامات حتى باللكنات الصحيحة.

جاء هذا التطوير الكبير بسبب تدريب المساعدين الشخصين على التحدث على جملة كاملة مرة واحدة وليس حرفاً بحرف. قدمت هذه الشبكة إمكانية التدرب على نطق تسلسل صوتي أقرب مايكون إلى الخطاب الأصلي من مجموعة من النصوص الصوتية المدربة عليها.

بمعنى أننا نستخدم نصوص الخطابات كمدخلات لهذه الشبكة، ونستخدم الصوت المقابل لهذه النصوص كمخرجات، ثم نطلب من الشبكة العصبية إنشاء مقطع صوتي للنص المدخل، ثم نقارن الخرج بالصوت الصحيح، ثم نحاول الإقتراب منه قدر الإمكان.
...
تأتي المساعدة من حقيقة أن النصوص والكلام والموسيقى عبارة عن تسلسل مع الوقت. يتكون من وحدات متتالية (مقاطع)، تبدو فريدة لو نظرنا إليها بشكل مستقل، لكن كل مقطع يعتمد على المقطع الذي يسبقه.

يمكننا تدريب شبكة مكثفة على توليد مثل هذه المقاطع، ولكن كيف ستتذكر هذه الشبكة المقاطع السابقة؟ لذا يمكننا اضافة ذاكرة إلى كل خلية عصبية تكون كمدخل إضافي عند توليد المقطع التالي، وكأن الخلايا تدون ملاحظة عن المقطع التي قامت بتوليدها سابقاً لتأخذ ذلك بعين الاعتبار أثناء توليد المقطع التالي، وكأنها تحدث نفسها لدينا حرف متحرك تم توليده سابقاً إذا ليبدو الصوت أعلى في المقطع التالي - هذا وصف مبالغ في تبسيطه لكنه للشرح فقط.
