...
هي الأشهر على الإطلاق في وقتنا الحالي، حيث تستخدم للبحث عن الكائنات في الصور، أو في مقاطع الفيديو، والتعرف على الوجوه، وإنشاء و تحسين وتحويل الصور، وإنشاء التأثيرات مثل الحركة البطيئة وتحسين جودة الصورة. تستخدم في جميع حالات الرؤية الحاسوبية حيث تعمل بكفائة عالية مع الصور.


![هذه الصورة من مشروع [Detectron](https://github.com/facebookresearch/Detectron)](/assets/detectron.jpg)

تكمن المشكلة مع الصور دائماً في صعوبة استخراج الميزات منها، فالنصوص يمكن ان تقسم حسب الجمل، أو حسب بعض الكلامات المفتاحية الموجودة فيها، إلى ذلك من الطرق، لكن لابد من تسمية الصور يدوياً لتعليم الآلة مكن وجودة عجلة الدراجة الهوائية أو مقودها في كل صور التدريب، لطالما استخدمت هذه الطريقة من جميع مهدسي تعليم الآلة تقريباً وتسمى صناعة الميزات يدوياً Handcrafting features
...
يسمي البعض هذه الطريق بالإلتفاف وكأنه يرى كيف أن القطع 8 * 8 تلتف على كامل اجزاء الصورة وتتعلم ماهو الخط المناسب لهذا الجزء منها.

ويسميها البعض طي وكأنه يرى الصورة أثناء طيها إلى طبقات تماماً كما الورقة قبل وضعها في جيبك فإنك تطويها إلى عدة طبقات تدعك بالنتيجة لا ترى إلى جزاء واحد منها، لتتعلم بعد ذلك ماهي الخطوط المناسبة لهذا الوجه.
