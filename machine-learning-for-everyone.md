...
في البداية علينا أن نستبعد كل الخرافات حول الذكاء الاصطناعي، فالهدف الوحيد من تعلم الآلة هو توقع النتائج بناءً على البيانات المدخلة.فقط!. وبالتالي نستطيع تمثيل جميع المشاكل التي يمكن حلها بتعلم الآلة بهذه الطريقة، فإذا لم نستطع تمثيل المشكلة على انها علاقة بين بيانات مدخلة ونتائج متوقعة فإن المشكلة لا يمكن حلها بالذكاء الاصطناعي من الأساس.
...
آلة متجهات الدعم Support Vector Machine SVM هي بحق الطريقة الأكثر شيوعاً للتصنيف الكلاسيكي. تم استخدامها لتصنيف كل ماهو موجود: النباتات في الصور، المستندات حسب فئاتها، وأي شيء يمكن أن يخطر لك.
