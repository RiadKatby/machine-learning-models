...
def get_model(model_name: str, model_version: int = None, # If none, return latest model
                tag_name: str = None,
                tag_value: str = None,
    ...
    Returns:
    A single aml model from the workspace that matches the name and tag, or None.
    """
